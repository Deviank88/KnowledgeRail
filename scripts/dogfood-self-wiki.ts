  ...
  return [
    ...
    },
    {
      ...
      body: [
        ...
        "",
        "Il registry multilingua assegna ogni file a un solo adapter deterministico per TypeScript/JavaScript, Java, Apex, C#, Go, Rust, PHP, C o C++. Ogni file conserva la versione del proprio parser, quindi rebuild e update riusano gli adapter invariati.",
        "",
        "## Lettura selettiva",
        "",
    ...
    },
    {
      ...
      body: [
        ...
        "- L'indice codice deve coprire tutti i linguaggi dichiarati senza fallback grep per i costrutti supportati.",
