...
const STATIC_DERIVED_PATHS = [
  ...
  ".knowledge-rail/semantic-vectors.bin",
  ".knowledge-rail/semantic-journal.bin",
...
async function rebuildDerivedIndexes(params: {
  ...
  const invalidated = [
    ...
    nodePath.join(wikiMetaDir(params.wikiRoot), "semantic-vectors.bin"),
    nodePath.join(wikiMetaDir(params.wikiRoot), "semantic-journal.bin"),
